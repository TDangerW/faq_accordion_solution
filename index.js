document.addEventListener("DOMContentLoaded", function () {
    ...
    divElements.forEach(function (div) {
        ...
        div.addEventListener('click', function () {
            ...
            image.src = image.src === ('https://tdangerw.github.io/faq_accordion_solution/assets/images/icon-plus.svg' || './assets/images/icon-plus.svg') ? 'https://tdangerw.github.io/faq_accordion_solution/assets/images/icon-minus.svg' : 'https://tdangerw.github.io/faq_accordion_solution/assets/images/icon-plus.svg'
        });
    });
});
